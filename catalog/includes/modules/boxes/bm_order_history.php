...
// retreive the last x products purchased
        ...
        if (tep_db_num_rows($orders_query)) {
          ...
          $customer_orders_string = '<table border="0" width="100%" cellspacing="0" cellpadding="1" class="infoBoxContents">';
          ...
          $data = '<div class="infoBoxContainer">' .
                  '  <div class="infoBoxHeading">' . MODULE_BOXES_ORDER_HISTORY_BOX_TITLE . '</div>' .
